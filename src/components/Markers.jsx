...
export const markers = [
  {
    ...
    icon: `${Sehenswert}`,
    audioUrl:
      "https://dl.sndup.net/j59w/Berlin%20verdankt%20das%20Brandenburger%20Tor%20K%C3%B6%20(1).mp3",
  },
  {
  ...
  },
  {
    ...
    extendedInfo:
      "Der Tiergarten ist eine große Parkanlage im Zentrum Berlins. Der Park ist bei den Berlinern sehr beliebt und bietet eine Oase der Ruhe und Entspannung im Herzen der Stadt. Der Park ist besonders schön im Frühling und Sommer, wenn die Bäume und Blumen blühen.",
    icon: `${Natur}`,
    audioUrl:
      "https://dl.sndup.net/j59w/Berlin%20verdankt%20das%20Brandenburger%20Tor%20K%C3%B6%20(1).mp3",
  },
  {
    ...
    location: { latitude: 52.519384, longitude: 13.35719 },
    info: "Schloss des Bundespräsidenten",
    extendedInfo:
      "Schloss Bellevue ist ein Schloss im Zentrum Berlins. Es wurde im Auftrag von König Friedrich Wilhelm III. erbaut und diente später als Gästehaus der Bundesregierung. Heute ist es der Amtssitz des Bundespräsidenten und kann nicht besichtigt werden. Es ist jedoch möglich, den Schlosspark zu besuchen.",
    icon: `${BestView}`,
    audioUrl:
      "https://dl.sndup.net/j59w/Berlin%20verdankt%20das%20Brandenburger%20Tor%20K%C3%B6%20(1).mp3",
  },
  ...
  {
    name: "Museumsinsel",
    location: { latitude: 52.51878, longitude: 13.40451 },
    info: "Weltberühmte Museen",
    extendedInfo:
      "Die Museumsinsel in Berlin ist ein einzigartiger Ort, der fünf weltberühmte Museen beherbergt. Die Gebäude und ihre Sammlungen sind von unschätzbarem Wert und ziehen jedes Jahr Millionen von Besuchern an.",
    icon: `${BestView}`,
  ...
  },
  {
    ...
    extendedInfo:
      "Das Bode-Museum beherbergt eine beeindruckende Sammlung von Skulpturen und Kunstwerken aus der byzantinischen Epoche. Es ist eines der fünf Museen auf der Museumsinsel und ein absolutes Muss für Kunstliebhaber.",
    icon: `${Museum}`,
  ...
  },
  {
    ...
    extendedInfo:
      "Die Alte Nationalgalerie auf der Museumsinsel ist ein weiteres Highlight für Kunstliebhaber. Hier sind hauptsächlich Kunstwerke des 19. Jahrhunderts zu finden, darunter Werke von Caspar David Friedrich, Adolph Menzel und vielen anderen.",
    icon: `${Museum}`,
  ...
  },
  {
    ...
    icon: `${Museum}`,
    audioUrl:
      "https://dl.sndup.net/c28y/Das%20Neue%20Museum%20beherbergt%20die%20%C3%84gypti.mp3",
  },
  {
    name: "Pergamonmuseum",
    ...
    extendedInfo:
      "Das Pergamonmuseum ist eines der fünf Museen auf der Museumsinsel in Berlin und beherbergt einige der bekanntesten archäologischen Schätze der Welt, darunter das berühmte Pergamon-Altar und das Ischtar-Tor. Das Museum wurde zwischen 1910 und 1930 von Alfred Messel und Ludwig Hoffmann erbaut.",
    icon: `${Museum}`,
    audioUrl:
      "https://dl.sndup.net/l07s/Das%20Pergamonmuseum%20beherbergt%20einige%20.mp3",
  },
  {
    name: "Altes Museum",
    location: { latitude: 52.518416, longitude: 13.406389 },
    ...
    extendedInfo:
      "Das Alte Museum ist das älteste Museum auf der Museumsinsel in Berlin und beherbergt die Antikensammlung. Das Gebäude wurde zwischen 1823 und 1830 von Karl Friedrich Schinkel im Stil des Klassizismus erbaut und war das erste öffentlich zugängliche Museum in Preußen.",
    icon: `${Museum}`,
    audioUrl:
      "https://dl.sndup.net/kh9n/Das%20Alte%20Museum%20ist%20das%20%C3%A4lteste.mp3",
  },
  {
    name: "Lustgarten",
  ...
  {
    name: "Humboldtforum",
    location: { latitude: 52.519171, longitude: 13.3975 },
  ...
  },
  {
    ...
    extendedInfo:
      "Die Neue Wache auf dem Platz der Republik in Berlin-Mitte ist ein Ehrenmal für die Opfer von Krieg und Gewaltherrschaft. Es wurde in den 1960er Jahren umgebaut und beherbergt heute eine Ausstellung zur Erinnerung an die Opfer von Krieg und Gewaltherrschaft.",
    icon: `${Sehenswert} `,
    audioUrl: "",
  },
  {
    ...
    extendedInfo:
      "Die Humboldt-Universität zu Berlin ist eine der ältesten Universitäten Berlins und eine der ältesten Universitäten Deutschlands. Sie wurde 1810 von den Brüdern Alexander und Wilhelm von Humboldt gegründet und gehört heute zu den renommiertesten Universitäten in Deutschland.",
    icon: `${Sehenswert}`,
    audioUrl: "",
  },
  {
  ...
  {
    name: "Neptunbrunnen",
    location: { latitude: 52.52246, longitude: 13.413746 },
