  ...
  return (
    <div>
      ...
      <div className={styles.AGBContainer}>
        <h2>Allgemeine Geschäftsbedingungen Stand: </h2>
        <h3>Februar 2023 Rechtliche Hinweise zur Benutzung: </h3>
        <p>
          {" "}
          ...
          stellt die IHK München und Oberbayern Musterverträge zur Verfügung.
          ...
          jedoch nicht von der sorgfältigen eigenverantwortlichen Prüfung. Aus
          Gründen der sprachlichen Vereinfachung wird auf die Nennung der
          ...
          männlichen Begriffe die weiblichen Formen ebenso mit ein. Der
          Mustervertrag ist nur ein Vorschlag für eine mögliche Regelung. Viele
          ...
          regelnde Situation und die Rechtsentwicklung erforderlich ist. Auf
        ...
        <h2>Allgemeine Geschäftsbedingungen für Tour Guide </h2>
        ...
        DemoShop) an Verbraucher gelten diese Allgemeinen Geschäftsbedingungen
        ...
        ihrer selbstständigen beruflichen Tätigkeit zugerechnet werden kann. 2.
        ...
        <h2>Allgemeine Geschäftsbedingungen für Tour Guide II </h2>
        <p>
          "../css/Datenschutz-AGB.module.css";il Adresse eintragen] mittels
          ...
          Mehrwertsteuer und sonstige Preisbestandteile. 5.2. Zusätzlich zu den
          ...
          Bestellseite nochmals deutlich mitgeteilt. 5.3. Bei Zahlung per
          ...
          nicht an. 6. Lieferung 6.1. Die Lieferung erfolgt nur innerhalb
          Deutschlands mit ____. 6.2. Die Lieferzeit beträgt bis zu 3 Tage. Auf
          ...
          Vorkasse oder Nachnahme. 7.2. Bei Auswahl der Zahlungsart Vorkasse
          nennen.
        </p>
        <span>
