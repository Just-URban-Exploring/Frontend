  ...
  return (
    <div>
      ...
      <div>
        ...
        Orientierungshilfe zu bieten, stellt die IHK München und Oberbayern
        Musterverträge zur Verfügung. Dieses Vertragsformular wurde mit größter
        Sorgfalt erstellt, erhebt aber keinen Anspruch auf Vollständigkeit und
        Richtigkeit. Es ist als Checkliste mit Formulierungshilfen zu verstehen
        und soll nur eine Anregung bieten, wie die typische Interessenlage
        zwischen den Parteien sachgerecht ausgeglichen werden kann. Dies
        entbindet den Verwender jedoch nicht von der sorgfältigen
        eigenverantwortlichen Prüfung. Aus Gründen der sprachlichen
        ...
        beziehen die verwendeten männlichen Begriffe die weiblichen Formen
        ebenso mit ein. Der Mustervertrag ist nur ein Vorschlag für eine
        mögliche Regelung. Viele Festlegungen sind frei vereinbar. Der Verwender
        kann auch andere Formulierungen wählen. Vor einer Übernahme des
        unveränderten Inhaltes muss daher im eigenen Interesse genau überlegt
        werden, ob und in welchen Teilen gegebenenfalls eine Anpassung an die
        konkret zu regelnde Situation und die Rechtsentwicklung erforderlich
        ist. Auf diesen Vorgang hat die Industrie- und Handelskammer natürlich
        keinen Einfluss und kann daher naturgemäß für die Auswirkungen auf die
        ...
        Rechtsanwalt Ihres Vertrauens beraten lassen. Allgemeine
        Geschäftsbedingungen für Tour Guide App 1. Geltungsbereich 2.
        Vertragspartner 3. Vertragsschluss 4. Widerrufsrecht 5. Preise und
        Versandkosten 6. Lieferung 7. Zahlung 8. Eigentumsvorbehalt 9.
        ...
        gelten diese Allgemeinen Geschäftsbedingungen (AGB). Verbraucher ist
        jede natürliche Person, die ein Rechtsgeschäft zu einem Zwecke
        abschließt, der überwiegend weder ihrer gewerblichen noch ihrer
        selbstständigen beruflichen Tätigkeit zugerechnet werden kann. 2.
        Vertragspartner Der Kaufvertrag kommt zustande mit DemoShop e.K.,
        Inhaber: Max Muster, Demostr. 1, 12345 Demostadt, Handelsregister:
        Amtsgericht Demostadt, HRA 12345. 3. Vertragsschluss 3.1. Die
        Darstellung der Produkte im Online-Shop stellt kein rechtlich bindendes
        Angebot, sondern nur eine Aufforderung zur Bestellung dar. 3.2. Durch
        ...
        Bestellung annehmen. 4. Widerrufsrecht 4.1. Wenn Sie Verbraucher sind
        ...
        Bestimmungen ein Widerrufsrecht zu. 4.2. Machen Sie als Verbraucher von
        Ihrem Widerrufsrecht nach Ziffer 4.1 Gebrauch, so haben Sie die
        regelmäßigen Kosten der Rücksendung zu tragen. 4.3. Im Übrigen gelten
        ...
        Preisen berechnen wir für die Lieferung innerhalb Deutschlands pauschal
        ____ Euro pro Bestellung. Die Versandkosten werden Ihnen auf den
        Produktseiten, im Warenkorbsystem und auf der Bestellseite nochmals
        deutlich mitgeteilt. 5.3. Bei Zahlung per Nachnahme wird zusätzlich eine
        Gebühr in Höhe von ____ Euro fällig, die der Zusteller vor Ort erhebt.
        Weitere Steuern oder Kosten fallen nicht an. 6. Lieferung 6.1. Die
        Lieferung erfolgt nur innerhalb Deutschlands mit ____. 6.2. Die
        Lieferzeit beträgt bis zu 3 Tage. Auf eventuell abweichende Lieferzeiten
        weisen wir auf der jeweiligen Produktseite hin. 7. Zahlung 7.1. Die
        Zahlung erfolgt wahlweise per Vorkasse oder Nachnahme. 7.2. Bei Auswahl
        der Zahlungsart Vorkasse nennen
        <span>
          Quelle: Online-Handel, Wegweiser durch die rechtlichen
          Rahmenbedingungen des E-Commerce unter Berücksichtigung des neuen
          Verbraucherrechts, von Rechtsanwalt Dr. Carsten Föhlisch/Trusted Shops
          GmbH und Rechtsanwalt Dr. Christian Groß/DIHK Deutscher Industrie-und
          Handelskammertag, DIHK Verlag, 2.Auflage 2018 (www.dihk-verlag.de )
          Hinweis: Die Veröffentlichung des Musters erfolgt mit freundlicher
          Genehmigung der Autoren. Die Widerrufsbelehrung ist aktualisiert und
          entspricht dem aktuellen Stand ab 28.05.2022 gemäß Anlage 1 zu Art.
          246 a § 1 Absatz 2 Satz 2 EGBGB. (Anl. 1 neu gef. mWv 13.6.2014 durch
          G v. 20.9.2013 (BGBl. I S. 3642); geänd. mWv 21.3.2016 durch G v.
        ...
        ist: Universalschlichtungsstelle des Bundes Zentrum für Schlichtung
        e.V., Straßburger Straße 8, 77694 Kehl am Rhein,
        www.verbraucher-schlichter.de. Zur Beilegung der genannten
        Streitigkeiten werden wir in einem Streitbeilegungsverfahren vor dieser
        Stelle teilnehmen. Alternativ: Die EU-Kommission hat eine
